...
exports.useWeb3Store = pinia_1.defineStore("web3", {
    state: function () {
        return {
            web3: null,
            account: null,
                    ...
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            window.ethereum.on("accountsChanged", function (accounts) {
                                _this.accounts = accounts || null;
                                if (!_this.accounts)
                                    _this.isConnected = false;
                            });
                            window.ethereum.on("chainChanged", function () { return __awaiter(_this, void 0, void 0, function () {
                                var _a;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
